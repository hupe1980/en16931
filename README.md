...
[`en16931-formats`](https://github.com/hupe1980/en16931-formats)'s job. It is a
separate crate because it depends on this one — so rustc forbids the reverse,
...
parser would end that, and adding a PDF parser takes the graph to 56 crates and
...
> (`UBL-*`, `CII-*`) belong to
> [`en16931-formats`](https://github.com/hupe1980/en16931-formats), and Peppol's
...
**CEN's unit tests** — 277 files, 1 131 assertions, each a minimal UBL fragment
